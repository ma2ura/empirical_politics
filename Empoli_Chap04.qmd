...
![Visual Studio Codeのオフィシャルサイト](./img/vscode01.png)

そして、「Visual Studio Codeをダウンロードする」をクリックすると、次のページにいきます。

![Visual Studio Codeのダウンロードページ](./img/vscode02.png)
...
![Quartoのオフィシャルサイト](./img/quarto01.png)

そして、「Get Started」をクリックすると、次のページにいきます。

![Quartoのダウンロードページ](./img/quarto02.png)
...
![VS Codeの拡張パッケージ](./img/vscode04.jpg)
