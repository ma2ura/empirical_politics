...
例えば，すべての企業が製造業か非製造業のどちらかに属する，とします。
そして，製造業に属するかどうかを表すダミー変数$mani$と，非製造業に属するかどうかを表すダミー変数$nomani$を作ります。
つまり，製造業であれば$mani = 1$，非製造業であれば$mani = 0$製造業ダミー変数と，非製造であれば$nomani = 1$，製造業であれば$nomani = 0$をとる非製造業ダミー変数ができます。
